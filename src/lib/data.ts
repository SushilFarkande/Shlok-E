...
export const services = [
  {
    ...
    description: "Expert diagnostics and repair for all commercial and home machines.",
    icon: "Wrench"
  },
  {
    id: "dryer",
    title: "Dryer Repair",
    description: "Fast and reliable dryer maintenance and heating element fixes.",
    icon: "Wind"
  },
  {
    id: "install",
    title: "Installation Service",
    description: "Professional setup of heavy-duty industrial laundry equipment.",
    icon: "Settings"
  },
  {
    id: "amc",
    title: "Annual Maintenance (AMC)",
    description: "Comprehensive yearly care to ensure zero downtime for your business.",
    icon: "ShieldCheck"
  }
];
